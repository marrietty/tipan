<button x-data="{ isDark: document.documentElement.classList.contains('dark') }"
        ...
        "
        type="button"
        class="inline-flex items-center justify-center p-2 text-body hover:text-primary transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded-lg"
